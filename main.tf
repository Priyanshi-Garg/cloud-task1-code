...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/Priyanshi-Garg/cloud-task1-code.git /var/www/html/"
...
provisioner "remote-exec" {
    inline = [
                "sudo su <<END",
                "sudo echo  \"<img src='http://${aws_cloudfront_distribution.task1-cloud.domain_name}/${aws_s3_bucket_object.image-upload.key}'  height='700' width='700' >\"  >> /var/www/html/index.html",
        "END",
             ]
  }
}
